package com.co.ias.reactive.webflux.configuration.routes;

import com.co.ias.reactive.webflux.services.TopicHandler;
...
public class TopicRoutes {
    ...
    @Bean
    public RouterFunction<ServerResponse> topicFunctionEndPoints(TopicHandler handler){
        return RouterFunctions
                ...
                .andRoute(DELETE(pathBase.concat("/{id}")).and(accept(MediaType.APPLICATION_JSON)),handler::deleteTopic);
